...
const packages = [
    {
        ...
        price: "₹1400",
        image:
            "https://img.freepik.com/free-photo/happy-family-sitting-sofa_23-2148303680.jpg", // replace with your image
    },
    {
        id: 2,
        name: "UNIFIT DIAMOND @ UNIPATH",
...
const structures = [
    ...
    },
    {
        id: 5,
        name: "Thyroid",
        icon: "https://img.icons8.com/color/96/thyroid.png",
    },
    {
        id: 6,
        name: "Liver",
        icon: "https://img.icons8.com/color/96/liver.png",
    },
    {
        id: 7,
        name: "Lungs",
    ...
    },
    {
        id: 9,
        name: "Allergy",
        icon: "https://img.icons8.com/color/96/sneeze.png",
    },
];



import { FlaskRound, ClipboardList, FileCheck2 } from "lucide-react"; // Example icons
                ...
                <div className="flex flex-wrap justify-center gap-8">
                    {structures.map((item) => (
                        <div key={item.id} className="text-center">
                            {/* Icon inside circle */}
                            <div className="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mx-auto shadow-sm hover:shadow-md transition">
                                <img src={item.icon} alt={item.name} className="w-12 h-12" />
                            </div>
                            <p className="mt-3 font-medium text-gray-800">{item.name}</p>
                        </div>
                    ))}
                </div>
            </div>
